...
/*
 	...
 	{			"title":"마포구, ‘마포순환열차버스’ 첫 운행 앞둬…골목상권 활성화",			
 				"originallink":"https:\/\/hobbyen-news.com\/news\/view\/1065582923310335",			"link":"https:\/\/hobbyen-news.com\/news\/view\/1065582923310335",			
...
public class NaverNewsSearch {
    ...
    public static List<NewsVO> newsSearchData(String fd) {
        ...
        // {key:value, key:value...} => Java => JavaScript
        ...
        String responseBody = get(apiURL,requestHeaders); // 출력 위치
