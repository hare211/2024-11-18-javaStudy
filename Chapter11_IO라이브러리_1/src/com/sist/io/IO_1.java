 ...
 * 		 = 파일 입출력
 * 		 = 네트워크 입출력
 * ** java.io : CheckException => 예외 처리가 필요하다
 * ** File => 파일 업로드 / 다운로드
 * 			  파일 읽기 / 쓰기
 * ** 관련 클래스
 * 1. File
 * 2. FileInputStream / FileOutputStream
 * 3. FileReader / FilWriter
 ...
 * 			6. 읽기 / 쓰기 : Boolean canRead(), Boolean canWrite()
 * 			7. long lastModified() : 최종 수정날짜
 * 				=> Date 를 이용해서 변환 => 날짜로 변경이 가능
 * 			8. 풀더 안에 있는 모든 파일 / 풀더 => String[] listFiles()
...
public class IO_1 {
	public static void main(String[] args) {
		...
		System.out.println("파일 크기 : " + file.length()); // byte 단위 => KB -> file.length() / 1024
